    ...
    <div class="card-header">
      <div class="d-flex justify-content-between">
        ...
        <div class="form-group">
          ...
          <button onclick="downloadDivAsImage()" class="btn btn-primary btn-sm"><i class="fa fa-download"></i> Unduh</button>
        </div>
      </div>
    </div>
    <div class="card-body">
      <div class="pembungkus" id="pembungkus">
        ...
        <p id="show-nama">{{@$sertifikat->nama}}</p>
        ...
        <p id="show-tanggal">{{@$sertifikat->created_at}}</p>
      </div>
    </div>
  </div>
</div>
...
<script>
  function downloadDivAsImage() {
    ...
    html2canvas(divToDownload).then(function(canvas) {
      ...
      link.download = 'e_sertifikat_{{@strtolower($sertifikat->nama)}}.png';
      link.href = image;
